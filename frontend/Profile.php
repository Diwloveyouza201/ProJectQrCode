    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="Activity_All.php">กิจกรรมทั้งหมด</a>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="#" data-toggle="modal" data-target="#Edit_Profile" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                class="fas fa-download fa-sm text-white-50"></i>แก้ไขโปรไฟล์</a> 
        </div>
    ...
    <div class="card mb-3">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <div class="row">
                        ...
                        <?php   
                            $conn = new dbconnect();
                            $Product_User = $conn->get_User();
                            $Data_User = $Product_User->fetch_assoc();
                        ?>
                     
                       <H6 >ชื่อ : <h5><?php echo $Data_User["Name"];?></h5> </H4> 
                        </div>
                        <div class="col"align="left">
                       <H6 >ชื่อเล่น : <h5><?php echo $Data_User["NickName"];?></h5> </H4> 
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"align="left">
                        <H6 >อีเมล : <h5><?php echo $Data_User["Email"];?></h5> </H6> 
                        </div>
                        <div class="col"align="left">
                        <H6 >อายุ : <br><h5><?php echo $Data_User["Age"];?><br> เพศ : <br><?php 
                        if($Data_User["Gender"]=="G01"){
                            echo "ชาย";
                        }
                        else{
                            echo "หญิง" ;
                    ...
                    <div class="row">
                        <div class="col"align="left">
                        <H6 >เบอร์โทร : <br><?php echo $Data_User["Phone"];?> </H6> 
                        </div>
                        <div class="col"align="left">
                        <H6 >Line : <br><?php echo $Data_User["Line_ID"];?> </H6> 
                        </div>
                    </div>
        ...
        <!-- <div class="card-footer  B-my-profile white:10px">
