    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">ข้อมูลคิวอาร์โค้ด</h1>  
                <a href="#" data-toggle="modal" data-target="#Add_Activity" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="btn-download" download="Image/qrdode.png"><i
                        class="fas fa-sm text-white-50"></i>บันทึกคิวอาร์โค้ด</a>   
            </div>

        </div>

        <!-- ----------ข้อมูลกินจกรรม------- -->
        <div>  <!-- Divใหญ่หน้าโชว์กิจกรรม -->
...
<a class="scroll-to-top rounded" href="#Data_QR">
