...
<body id="QR_Code_All">
        <?php
            ...
            $conn = new dbconnect();
            $product_QR = $conn->getShow_QR_Code_My();
        ?>
        <!-- Page Wrapper -->
        <div id="wrapper">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">คิวอาร์โค้ดทั้งหมด</h1>   
            </div>
  
                <div class="container-fluid">
                        <div class="row">   
                        <?php while($data_QR_Code = $product_QR->fetch_assoc()): ?>
                            <div class="col-xl-4 col-lg-5">
                                    <div class="card shadow mb-4">
                                    <img src="<?php echo $data_QR_Code['Qrcode_Path'];?>" alt="Avatar"  >            
                                    <div class="card-body">
                                            <h3 class="card-title"><?php echo $data_QR_Code['Event_Name'];?></h3>
                                            <div align="right" >
                                            
                                            <a class="btn btn-outline-primary" href="Data_QR.php?Qrcode_ID=<?php echo $data_QR_Code['Qrcode_ID'];?>">รายละเอียดเพิ่มเติม</a>
...
<a class="scroll-to-top rounded" href="#QR_Code_All">
