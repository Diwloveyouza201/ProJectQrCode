...
class dbconnect
{
    ...
    public function EditEvent($indexEvent, $folder)
    {
        ...
        $response = $client->request('POST', '/Qr_project/updateImgEvent', [
            'json' => [
                ...
                'eventparticulars' => "",
                'eventprovince' => "P19",
                'eventlocation' => "22221111",
                'eventdate' => "2021-09-28",
                'eventdateend' => "2021-10-17",
                'eventtime' => "01:25",
                'eventtimeend' => "02:23",
                'eventimage' => $folder,
                'evenrtype' => "1",
    ...
    public function insertComment($data, $eventid, $userid, $page)
    {
        ...
        Header("Location:data_Activity2.php?event=$page");
    }
    ...
    public function UPDATE_QR($Qrcode_ID, $Qrcode_Path)
    {
        ...
        echo "Update good";
        Header("Location:Activity_All2.php");
    }
    ...
    public function getdataQrCode($eventid)
    {
